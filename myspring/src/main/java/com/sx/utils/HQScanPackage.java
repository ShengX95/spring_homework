...
public class HQScanPackage
{
   ...
   /** 过滤器 **/
   private HQScanPackageFilter filter = null;
   /** 监听器 **/
   private HQScanPackageListener listener = null;
    ...
    * @param filter
    */
   public void setFilter(HQScanPackageFilter filter)
   {
      this.filter = filter;
   }
    ...
    * @param listener
    */
   public void setListener(HQScanPackageListener listener)
   {
    ...
    *
    */
   public static interface HQScanPackageFilter
   {
      /**
       * 是否接受
       * 
    ...
    *
    */
   public static interface HQScanPackageListener
   {
      /**
       * 扫描到合法类执行
       * 
   ...
   public static void main(String[] args)
   {
      ...
      scanPackage.addPackage(HQScanPackage.class.getPackage().getName());
